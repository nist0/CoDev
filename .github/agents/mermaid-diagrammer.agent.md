...
3. Check against GitHub constraints (node count ≤ 50, no deprecated `graph`/`stateDiagram` syntax, no cutting-edge beta features).
...
- [ ] Node count ≤ 50 for complex diagrams.
