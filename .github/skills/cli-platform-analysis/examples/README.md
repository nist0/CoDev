...
- **Test gates**: Coverage uploaded to Codecov; no threshold enforced yet ⚠️ (gap)
...
- **Action pin hygiene**: `actions/checkout` pinned to SHA ✅; `codecov/codecov-action` uses `@v4` tag ⚠️ (unpin risk)
