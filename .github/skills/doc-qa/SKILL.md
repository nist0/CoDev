...
- Use with prompt-engineering and prompt-authoring for prompt and doc linting.
- Combine with validation for CI doc quality gates.
- Integrate with repo-inventory for file enumeration.
{
## Gotchas
- Always run doc-qa before merging doc changes.
- Do not use workspace-wide globs; use Git-tracked file lists for validation.
...
- **Q: What if markdownlint fails?**
  ],
- **Q: Can I add custom lint rules?**
  "retryCount": 2,
  "timeout": "20s"
}
