...
Issue `#44` adds a lightweight feedback path for contributors who complete a key flow and want to report that it was useful, too long, or unclear without opening a full delivery issue.
